    ...
    switch (param_00) {
      ...
      case "damage_subpart":
        ...
        if(!scripts\sp\_utility::func_93A6()) {
          scripts\sp\_damagefeedback::func_4D4C(var_0D.var_3C, var_0D.var_4F, var_0D.var_F2, var_0D.point, undefined, var_0D.stopfxontag, undefined, var_0D.updategamerprofileall, undefined, var_0D.var_394);
        }
