...
updatefrontlinedebug() {
  ...
  if(!isdefined(var_2.logids) && isdefined(level.matchrecording_generateid)) {
    ...
    var_2.logids["alliesCenter"] = [
      [level.matchrecording_generateid]
    ]();
    var_2.logids["axisCenter"] = [
      [level.matchrecording_generateid]
    ]();
  }
  ...
  if(isdefined(level.matchrecording_logevent)) {
    ...
    ](var_2.logids["line"], "allies", var_07, var_5[0], var_5[1], gettime(), undefined, var_6[0], var_6[1]);
  }
  ...
  if(isdefined(level.matchrecording_logevent)) {
    ...
    [
      [level.matchrecording_logevent]
    ](var_2.logids["axisCenter"], "axis", "ANCHOR", var_8[0], var_8[1], gettime());
    var_09 = scripts\engine\utility::ter_op(var_2.isactive["allies"], var_2.func_1C27, (10000, 10000, 10000));
    [
      [level.matchrecording_logevent]
    ](var_2.logids["alliesCenter"], "allies", "ANCHOR", var_9[0], var_9[1], gettime());
  }
}
