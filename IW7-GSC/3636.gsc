...
func_2A33(param_00) {
  ...
  for (;;) {
    ...
    if(!self attackbuttonpressed()) {} else if(self issprinting()) {} else if(self issprintsliding()) {} else if(self ismeleeing()) {} else if(self isthrowinggrenade()) {} else if(self.var_9F47) {} else if(self.var_2A2F) {} else {
      ...
      if(self.var_2A2E) {
        scripts\sp\_utility::play_sound_on_entity("weap_steeldragon_powerdown");
        var_01 = undefined;
        if(!isdefined(var_01)) {
          var_02 = undefined;
          var_03 = undefined;
          ...
          foreach(var_06 in var_04) {
            if(!scripts\sp\_utility::isprimaryweapon(var_06)) {
              continue;
            }
        ...
        thread scripts\sp\_utility::play_sound_on_entity("weap_steeldragon_off");
      }
...
func_2A31(param_00) {
  ...
  thread scripts\sp\_utility::play_sound_on_entity("weap_steeldragon_charged");
}
