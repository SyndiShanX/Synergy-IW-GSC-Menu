...
func_106C1(param_00) {
  ...
  if(isdefined(self.triggerportableradarping) && level.player == self.triggerportableradarping) {
    var_01 = self.triggerportableradarping scripts\sp\_detonategrenades::func_734E();
    self.triggerportableradarping scripts\engine\utility::delaythread(1.25, ::scripts\sp\_detonategrenades::func_734D, param_00, var_01, level.player.var_612D.fgetarg);
  }
...
func_D044(param_00) {
  ...
  scripts\sp\_utility::play_sound_on_entity("emp_plr_strain");
}
...
func_6154(param_00) {
  ...
  scripts\engine\utility::delaythread(param_00, ::scripts\sp\_utility::play_sound_on_entity, "emp_nade_lp_end");
