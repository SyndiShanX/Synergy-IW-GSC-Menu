...
func_2AD0() {
  ...
  var_00.var_1581[4] = ::scripts\aitypes\zombie_sasquatch\behaviors::dotaunt;
  ...
  var_00.var_1581[7] = ::scripts\aitypes\zombie_sasquatch\behaviors::shouldmelee;
...
func_DEE8() {
  func_2AD0();
  btregistertree("zombie_sasquatch");
}