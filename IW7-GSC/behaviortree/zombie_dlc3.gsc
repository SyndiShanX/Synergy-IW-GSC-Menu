...
zombie_dlc3fn0(param_00) {
  return lib_0A09::func_5AEA(param_00, 200);
}

func_2AD0() {
  if(isdefined(level.var_119E["zombie_dlc3"])) {
    return;
  }
  ...
  var_00.var_1581[1] = ::scripts\aitypes\zombie_dlc3\behaviors::checkscripteddlc;
  ...
  var_00.var_1581[6] = ::zombie_dlc3fn0;
  ...
  var_00.var_1581[12] = ::scripts\aitypes\zombie_dlc3\behaviors::seekenemydlc;
  var_00.var_1581[13] = ::lib_0C2B::notargetfound;
  level.var_119E["zombie_dlc3"] = var_00;
}
