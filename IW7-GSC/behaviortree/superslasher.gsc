 ...
 * Script: behaviortree\superslasher.gsc
*****************************************/
...
func_2AD0() {
  ...
  var_00.var_1581[3] = ::scripts\aitypes\superslasher\behaviors::dointro;
  ...
  var_00.var_1581[10] = ::scripts\aitypes\superslasher\behaviors::dotaunt;
  ...
  var_00.var_1581[46] = ::scripts\aitypes\superslasher\behaviors::shouldmelee;
  ...
  var_00.var_1581[50] = ::scripts\aitypes\superslasher\behaviors::domelee;
  var_00.var_1581[51] = ::scripts\aitypes\superslasher\behaviors::melee_init;
  ...
  var_00.var_1581[65] = ::scripts\aitypes\superslasher\behaviors::move;
