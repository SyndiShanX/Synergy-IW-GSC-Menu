...
func_48C4(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07, param_08, param_09, param_0A, param_0B, param_0C, param_0D, param_0E) {
  ...
  if(isdefined(param_01)) {
    ...
    if(isdefined(self.model) && self.classname == "script_model" && scripts\sp\_utility::hastag(self.model, var_10)) {
...
func_48C6(param_00, param_01, param_02, param_03, param_04, param_05, param_06, param_07) {
  ...
  if(isdefined(param_00)) {
    ...
    if(isdefined(self.model) && self.classname == "script_model" && scripts\sp\_utility::hastag(self.model, "tag_origin")) {
...
func_4C1E() {
  ...
  var_02 = self.origin;
  thread scripts\sp\_utility::draw_circle(self.origin, self.var_13393, (0, 1, 0), 1, 0, 1);
  thread scripts\sp\_utility::draw_circle(self.origin, self.var_13078, (1, 0, 0), 1, 0, 1);
}