...
func_112BA(param_00) {
  ...
  var_02 = var_01[0];
  level.player thread scripts\sp\_utility::play_sound_on_entity("support_drone_activate");
  ...
  var_0D scripts\sp\_vehicle::playgestureviewmodel();
  var_0D _meth_839E();
  var_0D.var_6DA5 = 0;
  var_0D.var_C181 = 0;
...
func_5C55() {
  ...
  for (;;) {
    ...
    if(var_04 == "follow") {
      ...
      self.var_BE7A = scripts\sp\_utility::array_removedeadvehicles(self.var_BE7A);
...
func_5C56(param_00) {
  if(getdvarint("support_drone_debug")) {
    thread scripts\sp\_utility::draw_circle(self.var_4B2F + (0, 0, 16), self.var_4B2E, (1, 0, 0), 1, 0, 1);
  }
...
func_5C60(param_00) {
  thread scripts\sp\_utility::play_sound_on_entity("support_drone_lockon");
...
func_5C12() {
  self endon("death_anim");
  self endon("death");
  thread scripts\sp\_utility::play_loop_sound_on_tag("support_drone_windup", "tag_origin");
  wait(0.5);
