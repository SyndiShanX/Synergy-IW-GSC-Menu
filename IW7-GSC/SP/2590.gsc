...
func_236A(param_00) {
  ...
  if(!scripts\sp\utility::isfacialstateallowed("asm") && param_00 != "facial_death") {
    return;
  }
...
func_9DB5(param_00, param_01, param_02, param_03) {
  ...
  if(scripts\sp\utility::func_9DB4("iw7_sonic") && self.var_DE != "MOD_MELEE" && var_04 >= 75) {
    return 1;
  }
