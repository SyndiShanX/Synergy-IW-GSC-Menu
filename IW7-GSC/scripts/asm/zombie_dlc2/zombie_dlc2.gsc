 ...
 * Script: scripts\asm\zombie_dlc2\zombie_dlc2.gsc
***************************************************/
...
choosemovingdeathanim_dlc(param_00, param_01, param_02) {
  if(scripts\engine\utility::istrue(self.kung_fu_punched) && self.agent_type != "skater") {
    return scripts\asm\asm::asm_lookupanimfromalias(param_01, "kungfu");
  }
