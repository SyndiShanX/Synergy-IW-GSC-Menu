 ...
 * Script: scripts\cp\maps\cp_rave\cp_rave_weapon_upgrade.gsc
**************************************************************/
...
weapon_upgrade(param_00, param_01) {
  ...
  if(var_03 can_upgrade(var_04)) {
    ...
    if(var_05 == "dischord" || var_05 == "facemelter" || var_05 == "headcutter" || var_05 == "shredder") {
      var_03 thread scripts\cp\cp_vo::try_to_play_vo("pap_wor", "zmb_pap_vo", "high", undefined, undefined, undefined, 1);
    }
...
update_level_pap_machines(param_00, param_01, param_02, param_03, param_04) {
  ...
  foreach(var_07 in level.player_pap_machines) {
    ...
    if((scripts\engine\utility::istrue(var_07.triggerportableradarping.has_zis_soul_key) && var_05) || scripts\engine\utility::istrue(level.placed_alien_fuses) && var_05) {
...
get_pap_offhand_weapon(param_00, param_01) {
  ...
  foreach(var_04 in var_02) {
    if(!issubstr(param_01, var_04) && !scripts\cp\utility::isstrstart(var_04, "alt_") && !issubstr(var_04, "knife")) {
      return var_04;
    }
  }
...
process_pap_stat_logging(param_00, param_01) {
  ...
  param_01 scripts\cp\zombies\achievement::update_achievement("PUMP_IT_UP", 1);
}
