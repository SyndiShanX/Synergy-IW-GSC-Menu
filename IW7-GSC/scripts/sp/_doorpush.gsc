...
func_5A42(param_00) {
  ...
  switch (param_00) {
    case "unlocked":
      ...
      scripts\engine\utility::array_thread(self.var_ECCA, ::scripts\sp\_lights::func_AB83, 0.009, 0.05);
      scripts\engine\utility::array_thread(self.var_ECCA, ::scripts\sp\_lights::func_3C57, (0.26, 0.98, 0.18), 0.05);
      break;

    case "locked":
      scripts\engine\utility::array_call(self.var_ECCE, ::giveperk, "tag_locked");
      scripts\engine\utility::array_thread(self.var_ECCA, ::scripts\sp\_lights::func_AB83, 0.009, 0.05);
      scripts\engine\utility::array_thread(self.var_ECCA, ::scripts\sp\_lights::func_3C57, (0.98, 0.18, 0.26), 0.05);
      break;
...
func_5A34(param_00) {
  ...
  if(isdefined(param_00)) {
    switch (param_00) {
      case "open":
        self.var_5A3C give_attacker_kill_rewards(self.var_5A3C scripts\sp\_utility::func_7DC1(var_02));
        break;

      case "close":
        self.var_5A3C setanimknob(self.var_5A3C scripts\sp\_utility::func_7DC1(var_02), 1, 0, 0);
        break;
    }
  }
  ...
  if(isdefined(param_03)) {
    ...
    switch (param_00) {
      case "left_push":
        ...
        self.var_5A3C scripts\engine\utility::delaythread(2.6, ::scripts\sp\_utility::play_sound_on_tag, "shipcrib_door_left_hinge_push_release_and_close", "door_locked");
        break;

      case "left_pull":
        level.player playsound("shipcrib_door_left_hinge_pull_handle_down_open");
        self.var_5A3C scripts\engine\utility::delaythread(2.4, ::scripts\sp\_utility::play_sound_on_tag, "shipcrib_door_left_hinge_pull_release_and_close", "door_locked");
        break;

      case "right_push":
        level.player playsound("shipcrib_door_right_hinge_push_handle_down_open");
        self.var_5A3C scripts\engine\utility::delaythread(2.6, ::scripts\sp\_utility::play_sound_on_tag, "shipcrib_door_right_hinge_push_release_and_close", "door_locked");
        break;

      case "right_pull":
        level.player playsound("shipcrib_door_right_hinge_pull_handle_down_open");
        self.var_5A3C scripts\engine\utility::delaythread(2.4, ::scripts\sp\_utility::play_sound_on_tag, "shipcrib_door_right_hinge_pull_release_and_close", "door_locked");
        break;
    }
