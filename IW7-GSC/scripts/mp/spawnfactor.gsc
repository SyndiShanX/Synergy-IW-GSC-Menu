...
updatefrontlinedebug() {
  ...
  if(!isdefined(var_02.logids) && isdefined(level.matchrecording_generateid)) {
    ...
    var_02.logids["alliesCenter"] = [
      [level.matchrecording_generateid]
    ]();
    var_02.logids["axisCenter"] = [
      [level.matchrecording_generateid]
    ]();
  }
  ...
  if(isdefined(level.matchrecording_logevent)) {
    ...
    ](var_02.logids["line"], "allies", var_07, var_05[0], var_05[1], gettime(), undefined, var_06[0], var_06[1]);
  }
  ...
  if(isdefined(level.matchrecording_logevent)) {
    ...
    [
      [level.matchrecording_logevent]
    ](var_02.logids["axisCenter"], "axis", "ANCHOR", var_08[0], var_08[1], gettime());
    var_09 = scripts\engine\utility::ter_op(var_02.isactive["allies"], var_02.var_1C27, (10000, 10000, 10000));
    [
      [level.matchrecording_logevent]
    ](var_02.logids["alliesCenter"], "allies", "ANCHOR", var_09[0], var_09[1], gettime());
  }
}
