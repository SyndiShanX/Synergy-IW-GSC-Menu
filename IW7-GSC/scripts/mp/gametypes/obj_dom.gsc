...
domflag_setneutral(param_00) {
  ...
  if(isdefined(level.matchrecording_logevent) && isdefined(self.logid) && isdefined(self.logeventflag)) {
    ...
    ](self.logid, undefined, self.logeventflag, self.visuals[0].origin[0], self.visuals[0].origin[1], gettime(), 0);
  }
...
dompoint_setcaptured(param_00) {
  ...
  if(isdefined(level.matchrecording_logevent)) {
    [
      [level.matchrecording_logevent]
    ](self.logid, undefined, self.logeventflag, self.visuals[0].origin[0], self.visuals[0].origin[1], gettime(), scripts\engine\utility::ter_op(param_00 == "allies", 1, 2));
  }
...
dompoint_onuse(param_00) {
  ...
  if(!self.neutralized) {
    ...
    if(isdefined(level.onobjectivecomplete)) {
      ...
      ]("dompoint", self.label, param_00, var_01, var_02, self);
    }
