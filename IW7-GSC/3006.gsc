...
func_5EC8(param_00, param_01, param_02) {
  ...
  for (;;) {
    ...
    var_07 = self.origin;
    if(!scripts\sp\_utility::func_65DB("dynamicThrusters")) {} else {
...
func_774B(param_00) {
  foreach(var_02 in param_00) {
    thread scripts\sp\_utility::func_75C4(self.script_team + "_dropship_thrust_high", var_02);
  }
}
...
func_A61F() {
  ...
  foreach(var_05, var_01 in self.var_11854) {
    foreach(var_03 in self.var_11854[var_05].var_113EE) {
      thread scripts\sp\_utility::func_75A0(self.script_team + "_dropship_thrust_" + self.var_11865, var_03);
    }
  }
}
