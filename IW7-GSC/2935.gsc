...
func_1931() {
  ...
  for (;;) {
    ...
    if(isdefined(var_01) && isplayer(var_01)) {
      ...
      if(isdefined(var_0A) && scripts\sp\_utility::isprimaryweapon(var_0A) && isdefined(var_04) && var_04 == "MOD_PISTOL_BULLET" || var_04 == "MOD_RIFLE_BULLET") {
...
func_107F4() {
  ...
  scripts\sp\_gameskill::objective_state_nomessage();
}
...
func_107F3(param_00) {
  ...
  thread scripts\sp\_damagefeedback::monitordamage();
  func_F3D8();
...
camper_trigger_think(param_00) {
  ...
  scripts\engine\utility::array_thread(var_02, ::scripts\sp\_utility::func_1747, ::func_37E9);
  scripts\engine\utility::array_thread(var_02, ::scripts\sp\_utility::func_1747, ::func_BC9F, var_03);
  scripts\engine\utility::array_thread(var_02, ::scripts\sp\_utility::func_10619);
}
...
func_BC9F(param_00) {
  ...
  for (;;) {
    ...
    if(isplayer(self.isnodeoccupied)) {
      if(self.isnodeoccupied scripts\sp\_utility::func_65DB("player_has_red_flashing_overlay") || scripts\engine\utility::flag("player_flashed")) {
        self.logstring = 0;
        for (;;) {
...
func_DC9B(param_00) {
  ...
  waittillframeend;
  scripts\engine\utility::array_thread(var_01, ::scripts\sp\_utility::func_1747, ::func_2BD0);
  scripts\engine\utility::array_thread(var_01, ::scripts\sp\_utility::func_10619);
}
