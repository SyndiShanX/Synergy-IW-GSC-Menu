...
func_106B8(param_00, param_01, param_02, param_03, param_04, param_05) {
  ...
  var_1B = undefined;
  if(scripts\sp\_utility::hastag(var_09.model, "tag_origin")) {
    var_1B = "tag_origin";
  } else {
    var_1B = var_09.model;
  }
  ...
  var_09 scripts\sp\_vehicle::playgestureviewmodel();
  var_09 notsolid();
  ...
  if(isdefined(param_03)) {
    for (var_1C = 0; var_1C < param_03.size; var_1C++) {
      ...
      if(isai(param_03[var_1C])) {
        param_03[var_1C] scripts\engine\utility::delaythread(0.05, ::scripts\sp\_utility::func_11624, var_09.var_4D94.var_10DED[var_1D]);
      }
...
func_1179(param_00, param_01) {
  ...
  for (;;) {
    ...
    param_00.var_92E2 = scripts\sp\_utility::array_remove_index(param_00.var_92E2, var_04);
...
func_CCE5(param_00, param_01, param_02) {
  ...
  if(isdefined(param_01)) {
    ...
    if(isarray(param_01)) {
      if(var_06) {
        foreach(var_08 in param_01) {
          ...
          if(param_02 > 0) {
            self.var_C264 scripts\sp\_utility::func_50E4(param_02, ::scripts\engine\utility::stop_loop_sound_on_entity, param_01);
          }
        }
      ...
      foreach(var_08 in param_02) {
        self.var_C264 childthread scripts\sp\_utility::play_sound_on_entity(param_01);
      }
    ...
    if(var_0A) {
      ...
      if(var_08 > 0) {
        self.var_C264 scripts\sp\_utility::func_50E4(var_08, ::scripts\engine\utility::stop_loop_sound_on_entity, var_06);
        return;
      }
    ...
    self.var_C264 childthread scripts\sp\_utility::play_sound_on_entity(var_06);
    return;
  }
}
