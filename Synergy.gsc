...
menu_option() {
	...
	switch(menu) {
		...
		case "Zombie Options":
			...
			self add_array("Set Round Increment", undefined, ::set_round_increment, [1, 10, 20, 30, 40, 50]);
			...
			self add_array("Zombie ESP", "Set Colored Outlines around Zombies", ::set_outline_color, ["None", "White", "Red", "Green", "Aqua", "Orange", "Yellow"], true);
